  ...
  const handleFlutterwaveDeposit = async () => {
    ...
    try {
      ...
      const { error } = await supabase
        ...
        .insert({
          user_id: user?.id,
          amount_naira: 0, // Flutterwave handles USD directly
          amount_usd: amount,
          exchange_rate: 1, // 1:1 for USD
          status: 'pending',
    ...
    try {
      ...
      const { error } = await supabase
        ...
        .insert({
          ...
          amount_naira: 0,
          amount_usd: usdAmount,
          exchange_rate: 100, // SOL to USD rate
          status: 'pending',
            ...
            <div className="grid gap-6 md:grid-cols-3">
              ...
              <Card className="p-6 backdrop-blur-xl bg-white/5 border border-white/10">
                ...
                <div className="space-y-4">
                  ...
                  >
                    {processingDeposit ? 'Processing...' : 'Create Bank Transfer'}
              ...
              <Card className="p-6 backdrop-blur-xl bg-white/5 border border-white/10">
                ...
                <div className="space-y-4">
                  ...
                  {flutterwaveAmount && parseFloat(flutterwaveAmount) > 0 ? (
                    ...
                    <Button
                      disabled
                      className="w-full bg-gradient-to-r from-blue-500 to-blue-600 opacity-50"
                    >
